...
import { Eye, Volume2, Lock, Mic, Trash2, Copy, Edit2, Activity, Layers } from 'lucide-react';
...
export const Timeline: React.FC<TimelineProps> = ({ 
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#161616] select-none text-[10px] font-sans overflow-hidden relative">
      ...
      {/* Time Ruler & Toolbar */}
      <div className="h-8 bg-[#1e1e1e] border-b border-[#2a2a2a] flex items-center justify-between pr-4 relative">
          
          <div className="flex-1 h-full flex items-end ml-24 cursor-pointer relative" onClick={handleTimelineClick}>
          ...
          {/* Graph Editor Toggle */}
          <div className="flex items-center border-l border-[#333] pl-2 h-full z-40 bg-[#1e1e1e]">
              <button 
      ...
      <div className="flex-1 flex overflow-y-auto custom-scrollbar relative">
        ...
        {/* Track Headers (Only show in Layout View or Standard Mode) */}
        {!isGraphView && (
          ...
          {isGraphView ? (
              ...
              selectedLayer ? (
                  <GraphEditor 
                     ...
                     height={300} // Fixed height for graph editor view
                     onSeek={onSeek}
             ...
             <div className="relative w-full h-full" onClick={handleTimelineClick}>
                {/* Playhead Line */}
                <div 
